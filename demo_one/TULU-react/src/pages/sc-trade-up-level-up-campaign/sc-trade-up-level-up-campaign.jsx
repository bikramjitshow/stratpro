...
import ScTulu from "../../assets/sc-trade-up-level-up-campaign";

const TradeUpLevelUpCampaigns = () => {
  useEffect(() => {
    ScTulu.init();
  }, []);
  return (
        ...
        <div className="sc-tulu-camp-main active">
                ...
                <div className="sc-tulu-camp-milescard__inner">
                  <div className="sc-cvp__col">
                    <p className="sc-cvp__top">
                      Total Miles{" "}
                      <span
                        className="sc-tooltip sc-tooltip--blue"
                        tabIndex="0"
                      >
                        <svg
                          version="1.1"
                    ...
                    <p className="sc-cvp__bottom">
                      As of 20 Feb 2025 (1 Jan - 31 Mar 2024 Cycle)
                    </p>
                  </div>
                </div>
          ...
          <div className="sc-tulu-camp-tab">
            ...
            "perMove": "1"
                ...
                >
                  <div className="sc-tulu-camp-product-card sc-tulu-camp-product-card--blue">
                    <div className="sc-tulu-camp-product-card__main">
                      <div className="sc-tulu-camp-product-card__inner">
                        ...
                        <div className="sc-tulu-camp-product-card__details">
                          <p className="sc-tulu-camp-product-card__title">
                            Diversify
                          </p>
                          ...
                          <div className="sc-tulu-camp-product-card__progress">
                            <p className="sc-tulu-camp-product-card__progress-value">
                              5000
                            </p>
                    ...
                    <div className="sc-tulu-camp-product-card__bottom">
                      <p className="sc-tulu-camp-product-card__task">
                        Next Task
                      </p>
             ...
             2nd Tab Starts */}
                <div
                  className="sc-tulu-camp-tab__content-item"
                  data-tab-content="2"
                >
                  <div className="sc-tulu-camp-earnings">
                    <div className="sc-tulu-camp-earnings__inner">
                      <div className="sc-tulu-camp-earnings__title">
                        1 Mar 2022
                      </div>
                        ...
                        <div className="sc-tulu-camp-earnings__card sc-tulu-camp-earnings--blue">
                          <div className="sc-tulu-camp-earnings__left">
                            ...
                            <div className="sc-tulu-camp-earnings__text">
                              <div className="sc-tulu-camp-earnings__head">
                                Account Opening
                              </div>
                              <p className="sc-tulu-camp-earnings__sub-head">
                                FX
                              </p>
                            </div>
                          </div>
                            ...
                            <div className="sc-tulu-camp-timeline__box sc-tulu-camp-timeline__box--active">
                              <div className="sc-tulu-camp-timeline__box-wrapper">
                                ...
                                <div className="sc-tulu-camp-timeline__box-right">
                                  ...
                                  <p className="sc-tulu-camp-timeline__box-text">
                                    1000
                                  </p>
                                </div>
                              </div>
                    ...
                    <div className="sc-tulu-camp-timeline">
                      <div className="sc-tulu-camp-timeline__wrapper">
                        <div className="sc-tulu-camp-timeline__box sc-tulu-camp-timeline__box--disable">
                          <div className="sc-tulu-camp-timeline__box-wrapper">
                            <div className="sc-tulu-camp-timeline__box-title">
                              Finish all tradings with below products to earn
                              extra miles
                            </div>
                            <div className="sc-tulu-camp-timeline__box-right">
                              <div className="sc-tulu-camp-timeline__box-icon">
                          ...
                          <div className="sc-tulu-camp-progress sc-tulu-camp-progress--column-view">
                            <ul className="sc-tulu-camp-progress__inner">
                              <li className="sc-tulu-camp-progress__section sc-tulu-camp-progress__section--completed">
                                ...
                                <div className="sc-tulu-camp-progress__title">
                                  FX
                                </div>
                                <div className="sc-tulu-camp-progress__number">
                                  <svg
                            ...
                            <div className="sc-tulu-camp-timeline__box sc-tulu-camp-timeline__box--active">
                              ...
                              <div className="sc-tulu-camp-timeline__cvp">
                                ...
                                <div className="sc-tulu-camp-timeline__cvp-item sc-rte">
                                  <h2 className="sc-tulu-camp-timeline__cvp-title">
                                    REITs 101
                                  </h2>
        ...
        <div className="sc-tulu-camp-modal__dialog">
          <div className="sc-tulu-camp-modal__content ">
            <div className="sc-tulu-camp-modal__header">
              ...
              <p className="sc-tulu-camp-modal__header-title">
                Terms & Conditions
              </p>
                ...
                <div className="sc-tulu-camp-doc">
                  <div className="sc-tulu-camp-doc__tab-panel sc-sc-rte">
                    <article className="sc-tulu-camp-doc__content">
                      ...
                      <ul>
                        <li>
                          You (being the person named as the “applicant” in the
                          application) represent and warrant that all
                          information (including any documents) you have given
                          to us (being each member of the Standard Chartered
                          Group identified in the application or the approval as
                          the person providing the facility, product or service
                          to you, and its successors and assigns) in connection
                          with this application is correct, complete and not
                          misleading - important note: if this is not the case
                          you may be personally liable;
                        </li>
                        <li>
                          You acknowledge that we may decline your application
                          in its entirety or in part (in respect of any one or
                          more particular product(s), service(s) or account(s) /
                          sub-account(s) you are applying for in this
                          application) without giving you any reason for doing
                          so; if this happens, no contractual relationship
                          arises between you and us in respect of any
                          product(s), service(s) or account(s) / sub-account(s)
                          requested in this application which we have declined
                          to provide to you;
                        </li>
                        <li>
                          Renminbi (“RMB”) exchange rate, like any other
                          currency, is affected by a wide range of factors and
                          is subject to fluctuations. Such fluctuations may
                          result in gains and losses in the event that the
                          client subsequently converts RMB to another currency
                          (including Hong Kong dollars); and
                        </li>
                        <li>
                          RMB is currently not freely convertible and conversion
                          of RMB through banks in Hong Kong is subject to
                          restrictions specified by the Bank and regulatory
                          requirements applicable from time to time. The actual
                          conversion arrangement will depend on the restrictions
                      ...
                      <ul>
                        <li>
                          Deposit(s) in the Account(s) applied for hereunder is
                          (are) deposit(s) qualified for protection under the
                          Deposit Protection Scheme in Hong Kong. However, a
                          time deposit with a tenor exceeding 5 years or a
                          deposit subject to any foreign exchange forward
                          contract under Currency Switching services will NOT be
                          protected under the Scheme.
                        </li>
                        <li>
                          If there is any inconsistency between the English
                          version and the Chinese version of this application
                          form, the English version prevails.
                        </li>
                        <li>
              ...
              <div className="sc-tulu-camp__wrapper">
                <div className="sc-tulu-camp-questionnaire">
                  <div className="sc-tulu-camp-questionnaire__test sc-sc-rte">
                    ...
                    <h2 className="sc-tulu-camp-questionnaire__heading">
                      REITs 101
                    </h2>
                    <p className="sc-tulu-camp-questionnaire__test-text">
                  ...
                  <div className="sc-tulu-camp-questionnaire__question">
                    <p className="sc-tulu-camp-questionnaire__question-text">
                      What is the minimum percentage of taxable income tha
                      tREITs must distribute to Unit holders as dividends each
                      year?
                    </p>
                    ...
                    <div className="sc-tulu-camp-questionnaire__feedback-desc">
                      Explanation goes here. Lorem ipsum dolor sit amet,
                ...
                <div className="sc-tulu-camp-doc">
                  <div className="sc-tulu-camp-doc__tab-panel sc-rte">
                    <article className="sc-tulu-camp-doc__content">
                        ...
                        <ul className="sc-tulu-camp-how-it-works__card">
                          <li className="sc-tulu-camp-how-it-works__card-item">
                            ...
                            <div className="sc-tulu-camp-how-it-works__item-description">
                              Click below &quot;Get Started&quot; button to join
                              the promotion.
                            </div>
                          </li>
                          <li className="sc-tulu-camp-how-it-works__card-item">
                            ...
                            <a
                              href="#"
                              className="sc-tulu-camp-how-it-works__item-link"
                            >
                              See Missions &gt;&gt;
                            </a>
                          </li>
                          <li className="sc-tulu-camp-how-it-works__card-item">
                            ...
                            <div className="sc-tulu-camp-how-it-works__item-description">
                              Check your progress and see how close you are to
                              leveling up.
                            </div>
                          </li>
                        </ul>
                      ...
                      <p>
                        Your tracker updates within 2 days after successful
                        registration. If it’s been longer and your tracker still
                        isn’t updated, please contact support for assistance.
                      </p>
                    </article>
                  </div>
                </div>
                        ...
                        <div className="sc-content-wrapper">
                          ...
                          <div className="sc-faq__accordion">
                            ...
                            <div className="sc-faq__accordion-content sc-rte">
                              The SC Referral Club is open to all existing
                              primary account holder of deposit accounts and
                              principal cardholders of credit cards to invite
                              their friends to Standard Chartered and earn
                              CashBack/cash rebates or Asia Miles on successful
                              referrals.
                            </div>
                          </div>
                          <div className="sc-faq__accordion">
                            ...
                            <div className="sc-faq__accordion-content sc-rte">
                              For details on Referrer offers, please refer to
                              the Additional Terms and Conditions of the
                              respective SC Referral Club Programs/Products.
                            </div>
                          </div>
                          <div className="sc-faq__accordion">
                            <input
                            ...
                            <div className="sc-faq__accordion-content sc-rte">
                              Your friend and family will receive a sign-up
                              reward if he/she has successfully signed up for an
                              eligible product and fulfil the sign-up
                              eligibility criteria. for details, please refer to
                              each of the Terms and Conditions of these products
                          ...
                          <div className="sc-faq__accordion">
                            ...
                            <label
                              ...
                              htmlFor="four"
                            >
                              Are there any restrictions and/or eligibility
                              criteria for referrals?
                            </label>
                            <div className="sc-faq__accordion-content sc-rte">
                              For details on Referee eligibility for each
                              Products/Programs on New Services(s) , please
                              refer to the Additional Terms and Conditions of
                          ...
                          <div className="sc-faq__accordion">
                            ...
                            <div className="sc-faq__accordion-content sc-rte">
                              Your referral cashback will be credited to your
                              account. For detail timing for each
                              product/program, please refer to each of the Terms
...
export default TradeUpLevelUpCampaigns