...
export const ScFooter = function() {
  return (
    <footer className="sc-footer">
      <div className="sc-content-wrapper">
        ...
        <div className="sc-footer__content-wrapper">
          <div className="sc-footer__list-container">
            ...
            <ul className="sc-footer__list">
              ...
              <li className="sc-footer__item">
                <a
                  className="sc-footer__item-link"
                  href="https://www.sc.com/sg/bank-with-us/"
                  title="Bank with US"
                  target="_self"
                >
                  Bank with US
              ...
              <li className="sc-footer__item">
                <a
                  className="sc-footer__item-link"
                  href="https://www.sc.com/sg/atm-branch-locator/"
                  title="ATM &amp; Branches"
                  target="_self"
                >
                  ATM &amp; Branches
              ...
              <li className="sc-footer__item">
                <a
                  className="sc-footer__item-link"
                  href="https://www.sc.com/sg/help/contact-us/"
                  title="Contact Us"
                  target="_self"
                >
                  Contact Us
              ...
              <li className="sc-footer__item">
                <a
                  className="sc-footer__item-link"
                  href="https://www.sc.com/sg/help/#faq"
                  title="FAQ"
                  target="_self"
                >
                  FAQ
              ...
              <li className="sc-footer__item">
                <a
                  className="sc-footer__item-link"
                  href="https://av.sc.com/sg/content/docs/sg-scb-pricing-guide.pdf"
                  title="Fees &amp; Charges"
                  target="_self"
                >
                  Fees &amp; Charges
              ...
              <li className="sc-footer__item">
                <a
                  className="sc-footer__item-link"
                  href="https://www.sc.com/sg/help/forms/"
              ...
              <li className="sc-footer__item">
                <a
                  className="sc-footer__item-link"
                  href="https://www.sc.com/sg/pricing-guide/"
                  title="Pricing Guide"
                  target="_self"
                >
                  Pricing Guide
              ...
              <li className="sc-footer__item">
                <a
                  className="sc-footer__item-link"
                  href="https://www.sc.com/sg/important-information/"
          ...
          <div className="sc-footer__list-container">
            <input
              className="sc-footer__input"
              id="sc-footer-center"
              tabIndex="-1"
              type="checkbox"
            />
            <label className="sc-footer__label" htmlFor="sc-footer-center">
              Support
            </label>
            <ul className="sc-footer__list">
              <li className="sc-footer__item">
                <a
                  className="sc-footer__item-link"
                  href="https://www.sc.com/sg/market-outlook/?intcid=web&amp;lang=en&amp;ctry=SG&amp;seg=GWM&amp;channel=PLRB"
                  title="Our Thinking"
                  target="_self"
                >
                  Our Thinking
              ...
              <li className="sc-footer__item">
                <a
                  className="sc-footer__item-link"
                  href="https://www.sc.com/sg/investors/"
                  title="Investors"
                  target="_self"
                >
                  Investors
              ...
              <li className="sc-footer__item">
                <a
                  className="sc-footer__item-link"
                  href="https://www.sc.com/sg/news-media/"
                  title="News &amp; Media"
                  target="_self"
                >
                  News &amp; Media
              ...
              <li className="sc-footer__item">
                <a
                  className="sc-footer__item-link"
                  href="https://www.sc.com/sg/about-us/awards-achievements/"
              ...
              <li className="sc-footer__item">
                <a
                  className="sc-footer__item-link"
                  href="https://www.sc.com/en/global-careers/experienced-hire/spotlight-career-opportunities/singapore/"
                  title="Careers"
                  target="_self"
                >
                  Careers
          ...
          <div className="sc-footer__list-container">
            <input
              ...
              type="checkbox"
            />
            <label className="sc-footer__label" htmlFor="sc-footer-right">
              Legal
            </label>
            <ul className="sc-footer__list">
              <li className="sc-footer__item">
                <a
                  className="sc-footer__item-link"
                  href="http://www.speakingupsc.ethicspoint.com/"
                  title="Speak Up"
                  target="_self"
                >
                  Speak Up
              ...
              <li className="sc-footer__item">
                <a
                  className="sc-footer__item-link"
                  href="https://www.sc.com/sg/fraud-scam/"
                  title="Fraud &amp; Scam"
                  target="_self"
                >
                  Fraud &amp; Scam
              ...
              <li className="sc-footer__item">
                <a
                  className="sc-footer__item-link"
                  href="https://www.sc.com/sg/community-impact/"
              ...
              <li className="sc-footer__item">
                <a
                  className="sc-footer__item-link"
                  href="https://sc.com/sg/cookie-policy/"
                  title="Cookie Policy"
                  target="_self"
                >
                  Cookie Policy
              ...
              <li className="sc-footer__item">
                <a
                  className="sc-footer__item-link"
                  href="https://www.sc.com/sg/terms-and-conditions/"
              ...
              <li className="sc-footer__item">
                <a
                  className="sc-footer__item-link"
                  href="https://www.sc.com/sg/privacy-notice/"
          ...
          <div className="sc-footer__list-container sc-footer__list-container--width">
            <div className="sc-footer__apps">
              <p className="sc-footer__apps-text">Download our App now</p>
              <div className="sc-footer__apps-container">
                <a
                  href="https://apps.apple.com/sg/app/sc-mobile-singapore-breeze/id367337298"
                  target="_blank"
                  rel="noreferrer"
                  title="App Store"
                  className="sc-footer__apps-icon icon-app-store"
                >
                  <svg
                    width="114"
                    height="33"
                ...
                <a
                  ...
                  rel="noreferrer"
                  title="Play Store"
                  className="sc-footer__apps-icon icon-google-play"
                >
                  <svg
                    width="116"
                    height="29"
                ...
                <a
                  href="https://huaweimobileservices.com/appgallery/"
                  target="_blank"
                  rel="noreferrer"
                  title="Huawei App Gallery"
                  className="sc-footer__apps-icon icon-sc-huawei-app-gallery"
                >
                  <svg
                    width="126"
                    height="29"
            ...
            <div className="sc-footer__social">
              <p className="sc-footer__social-text">Follow Us</p>
              <ul className="sc-footer__social-list">
                <li className="sc-footer__social-item">
                  <a
                    href="https://www.facebook.com/Standardcharteredsg/"
                    target="_blank"
                    rel="noreferrer"
                    title="Facebook"
                    className="sc-footer__social-icon"
                  >
                    <svg
                      width="10"
                      height="20"
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M9.02 9.908H5.931v9.111H2.11V9.908H0V6.907h2.11V3.88C2.11 2.366 2.914 0 5.936 0l3.388.011v3.693H6.433c-.322 0-.502.168-.502.89v2.314H9.34l-.32 3z"
                        fill="#fff"
                      ></path>
                    </svg>
                  </a>
                ...
                <li className="sc-footer__social-item">
                  <a
                    href="https://twitter.com/StanChart"
                    target="_blank"
                    rel="noreferrer"
                    title="Twitter"
                    className="sc-footer__social-icon"
                  >
                    ...
                    >
                      <path
                        d="M21.025 19.59c-2.428-3.24-4.86-6.483-7.289-9.727l-1.062 1.128c2.376 3.173 4.755 6.342 7.135 9.51.044.058.088.115.132.177H16.87l-5.84-7.933-1.062 1.133c1.402 1.904 2.803 3.808 4.204 5.707l1.93 2.618H23c-.666-.868-1.318-1.741-1.975-2.614zM3.301 2.251h2.816l2.37 3.165c1.076 1.432 2.151 2.869 3.226 4.3.353-.378.706-.753 1.063-1.127C10.81 5.972 8.845 3.35 6.878.728H.277c1.86 2.525 3.715 5.05 5.575 7.575 1.058 1.432 2.111 2.86 3.164 4.292.353-.379.705-.753 1.063-1.132L3.3 2.253z"
                        fill="#434343"
                      ></path>
                      <path
                        d="M11.03 12.75c-.356.379-.709.758-1.061 1.132-1.785 1.904-3.574 3.808-5.36 5.707-.819.873-1.634 1.745-2.454 2.618H0l2.455-2.618 3.41-3.635c1.054-1.12 2.103-2.24 3.156-3.363.353-.379.705-.753 1.062-1.132l.948 1.29zM22.313.723c-2.86 3.045-5.72 6.095-8.576 9.14l-1.062 1.128-.961-1.282c.352-.379.705-.754 1.062-1.128 2.459-2.618 4.914-5.24 7.373-7.862h2.164v.004z"
                        fill="#434343"
                      ></path>
                      <path
                        d="M21.025 19.59c-2.428-3.24-4.86-6.483-7.289-9.727l-1.062 1.128c2.376 3.173 4.755 6.342 7.135 9.51.044.058.088.115.132.177H16.87l-5.84-7.933-1.062 1.133c1.402 1.904 2.803 3.808 4.204 5.707l1.93 2.618H23c-.666-.868-1.318-1.741-1.975-2.614zM3.301 2.251h2.816l2.37 3.165c1.076 1.432 2.151 2.869 3.226 4.3.353-.378.706-.753 1.063-1.127C10.81 5.972 8.845 3.35 6.878.728H.277c1.86 2.525 3.715 5.05 5.575 7.575 1.058 1.432 2.111 2.86 3.164 4.292.353-.379.705-.753 1.063-1.132L3.3 2.253z"
        ...
        <div className="sc-footer__copy">
          <div>
            <div>© Standard Chartered Bank (Singapore) Limited | Reg no. 201224747C</div>
          </div>
        </div>
      </div>

      <button title="Back to Top" className="sc-footer__back-to-top"></button>
    </footer>
  );
};
