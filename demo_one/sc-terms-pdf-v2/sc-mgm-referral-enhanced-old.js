...
class ScMgmReferralEnhanced {
  ...
  init() {
    ...
    that.viewAllDiv = that.productTile.querySelector(
    ...
    // const producttiles = that.productTile.querySelectorAll(".sc-product-tile");
    // if(producttiles.length) {
    //   producttiles.forEach(producttile => {
    //     producttile.getAttribute("data-single-view");
    //   })
    // }
  ...
  handleSingleView() {
    ...
    if (pdtId) {
      // Display products in recommended tiles
      that.backBtn.classList.add("hide");
      const recommendedTile = that.productTile.querySelector(
        ".sc-product-tile-recommended"
      );
      recommendedTile.classList.remove("hide");
  ...
  termsModalActive(event) {
    ...
    console.log("2.....");
    if (that.isTermModalRequire) {
      console.log("3..... that.isTermModalRequire = true");
      that.isTermModalActive = true;
      if (
        closestAnchor &&
      ...
      console.log("7..... that.isTermModalRequire = false");
      let modalAttr = closestAnchor.getAttribute("data-modal-source");
