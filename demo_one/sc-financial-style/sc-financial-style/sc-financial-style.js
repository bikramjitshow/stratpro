...
class FinancialStyle {
  init() {
    ...
    let dataObject = JSON.parse(financialStyleElement.getAttribute('data-req-json'));
    ...
    document.addEventListener('click', function(event) {
      ...
      let segmentOneSection = document.querySelector('.sc-financial-style__segment-one');
      let segmenttwoSection = document.querySelector('.sc-financial-style__segment-two');
      let segmentThreeSection = document.querySelector('.sc-financial-style__segment-three');
      let segmentFourSection = document.querySelector('.sc-financial-style__segment-four');
      let questionOne = document.querySelector('.sc-financial-style__question-one');
      let questionTwo = document.querySelector('.sc-financial-style__question-two');
      let questionThree = document.querySelector('.sc-financial-style__question-three');
      ...
      if (clickedElement.classList.contains('sc-financial-style__segment-one-button')) {
      ...
      } else if (clickedElement.classList.contains('sc-financial-style__segment-two-button')) {
        ...
        switch (questionCounter) {
          case 2:
            ...
            if (document.querySelector('input[name="radio-box-q2"]:checked') === null) {
              document
                .querySelector('.sc-financial-style__error-container')
                .classList.remove('hide');
            } else {
              document.querySelector('.sc-financial-style__error-container').classList.add('hide');
              singleSelectedAnswer = document.querySelector('input[name="radio-box-q2"]:checked')
                .value;
          ...
          case 3:
            ...
            if (document.querySelector('input[name="radio-box-q3"]:checked') === null) {
              document
                .querySelector('.sc-financial-style__error-container')
                .classList.remove('hide');
            } else {
              document.querySelector('.sc-financial-style__error-container').classList.add('hide');
              singleSelectedAnswer = document.querySelector('input[name="radio-box-q3"]:checked')
                .value;
              singleSelectedText = document
              ...
              if (
                ...
                (_dataObject$result$se = _dataObject$result[selectedAnswers['q1']]) !== null &&
                _dataObject$result$se !== void 0 &&
                (_dataObject$result$se2 = _dataObject$result$se[selectedAnswers['q2']]) !== null &&
                _dataObject$result$se2 !== void 0 &&
                (_dataObject$result$se3 = _dataObject$result$se2[selectedAnswers['q3']]) !== null &&
                ...
                document.querySelector('.sc-financial-style__segment-three-prod-name').innerHTML =
                  (_dataObject$result2 = dataObject['result']) === null ||
                  _dataObject$result2 === void 0
                    ? void 0
                    : (_dataObject$result2$s = _dataObject$result2[selectedAnswers['q1']]) ===
                        null || _dataObject$result2$s === void 0
                    ? void 0
                    : (_dataObject$result2$s2 = _dataObject$result2$s[selectedAnswers['q2']]) ===
                        null || _dataObject$result2$s2 === void 0
                    ? void 0
                    : (_dataObject$result2$s3 = _dataObject$result2$s2[selectedAnswers['q3']]) ===
              ...
              if (
                ...
                (_dataObject$result3$s = _dataObject$result3[selectedAnswers['q1']]) !== null &&
                _dataObject$result3$s !== void 0 &&
                (_dataObject$result3$s2 = _dataObject$result3$s[selectedAnswers['q2']]) !== null &&
                _dataObject$result3$s2 !== void 0 &&
                (_dataObject$result3$s3 = _dataObject$result3$s2[selectedAnswers['q3']]) !== null &&
                ...
                document.querySelector('.sc-financial-style__segment-three-prod-desc').innerHTML =
                  (_dataObject$result4 = dataObject['result']) === null ||
                  _dataObject$result4 === void 0
                    ? void 0
                    : (_dataObject$result4$s = _dataObject$result4[selectedAnswers['q1']]) ===
                        null || _dataObject$result4$s === void 0
                    ? void 0
                    : (_dataObject$result4$s2 = _dataObject$result4$s[selectedAnswers['q2']]) ===
                        null || _dataObject$result4$s2 === void 0
                    ? void 0
                    : (_dataObject$result4$s3 = _dataObject$result4$s2[selectedAnswers['q3']]) ===
          ...
          default:
            ...
            if (document.querySelector('input[name="radio-box-q1"]:checked') === null) {
              document
                .querySelector('.sc-financial-style__error-container')
                .classList.remove('hide');
            } else {
                ...
                if (question2['type'] === 'image') {
                  ...
                  if (question2['options']) {
                    ...
                    <div class="sc-radio-box sc-financial-style__full-width">
                      ...
                      <label class="sc-radio-box__input-label" for="radio-box-q2-${index +
                        1}" tabindex="0">${currentElement['optLabel']}. ${
                        currentElement['optText']
                      }</label>
                    </div>
                  </div>`;
              ...
              if (questionTwoNextButton) {
                questionTwoNextButton.classList.remove('sc-financial-style__full-width');
                questionTwoNextButton.classList.add('sc-financial-style__segment-next-btn');
              }
              // update question counter and show hide questions
              questionCounter = 2;
              questionOne.style.display = 'none';
      ...
      } else if (clickedElement.classList.contains('sc-financial-style__back-btn')) {
        ...
        switch (questionCounter) {
          ...
          default:
            ...
            if (questionTwoNextButton) {
              questionTwoNextButton.classList.remove('sc-financial-style__segment-next-btn');
              questionTwoNextButton.classList.add('sc-financial-style__full-width');
            }
            // show hide questions
      ...
      } else if (clickedElement.classList.contains('sc-financial-style__segment-three-button')) {
        // If user click on appointment button
        document.querySelector(
          '.sc-financial-style__questions'
        ).value = Utils.getLocalStorageWithExpiry(key);
        segmentThreeSection.style.display = 'none';
        segmentFourSection.style.display = 'block';
      } else if (clickedElement.classList.contains('sc-financial-style__segment-four-button')) {
  ...
  financialFormValid() {
    let formStatus = true;
    var fullName = document.querySelector('.sc-input__name').value;
    if (fullName === '') {
      formStatus = false;
      document.querySelector('.sc-form__error-name').classList.remove('hide');
    } else {
      document.querySelector('.sc-form__error-name').classList.add('hide');
    }

    const phone = document.querySelector('.sc-input__input--phonenumber').value;
    const countryCode = document.querySelector('.sc-input__country').value;
    if (phone === '' || phone.length < 8 || countryCode === '') {
      formStatus = false;
      document.querySelector('.sc-form__error-contact').classList.remove('hide');
    } else {
      document.querySelector('.sc-form__error-contact').classList.add('hide');
    }

    var email = document.querySelector('.sc-input__input-email').value;

    if (email !== '') {
      // Check for the presence of "@" and "."
      // Not using Regex becuase of HTML CT limitation in CMS editor.
      var atIndex = email.indexOf('@');
      var dotIndex = email.lastIndexOf('.');
      var isValid = atIndex > 0 && dotIndex > atIndex + 1 && dotIndex < email.length - 1;

      if (!isValid) {
        formStatus = false;
        document.querySelector('.sc-form__error-email').classList.remove('hide');
      } else {
        document.querySelector('.sc-form__error-email').classList.add('hide');
      }
    }
    let membership = document.querySelector('.sc-input__input-membership').value;
    if (membership !== '') {
      let totNumber = 0;
      let multipliedNumber = 0;
      if (membership.length != 10) {
        formStatus = false;
        document.querySelector('.sc-form__error-membership').classList.remove('hide');
      } else {
        if (membership[0] < 1) {
          formStatus = false;
          document.querySelector('.sc-form__error-membership').classList.remove('hide');
        } else {
          for (let count = 1; count < membership.length; count++) {
            multipliedNumber = membership[count - 1] * count;
            totNumber = totNumber + multipliedNumber;
          }
          let checkDigit = totNumber % 10;
          if (checkDigit != membership[9]) {
            formStatus = false;
            document.querySelector('.sc-form__error-membership').classList.remove('hide');
          } else {
            document.querySelector('.sc-form__error-membership').classList.add('hide');
          }
        }
      }
    } else {
    ...
    var membershipFamilyName = document.querySelector('.sc-input__input-membership-family-name')
      .value;
    if (membershipFamilyName === '') {
      formStatus = false;
      document.querySelector('.sc-form__error-membership-family-name').classList.remove('hide');
    } else {
      document.querySelector('.sc-form__error-membership-family-name').classList.add('hide');
    }
    var membershipGivenName = document.querySelector('.sc-input__input-membership-given-name')
      .value;
    if (membershipGivenName === '') {
      formStatus = false;
      document.querySelector('.sc-form__error-membership-given-name').classList.remove('hide');
    } else {
      document.querySelector('.sc-form__error-membership-given-name').classList.add('hide');
    }
    if (document.querySelector('.sc-select__branch').value === '0') {
      formStatus = false;
      document.querySelector('.sc-form__error-branch').classList.remove('hide');
    } else {
  ...
  sendFormData() {
    ...
    let form = document.querySelector('.sc-financial-style__segment-four .sc-form.modular-form');
    ...
    xhr.onload = function(res) {
      if (xhr.status === 200) {
        ...
        if (failedIndex >= 0) {
          let failureHtml =
            '<div class="failureNote">' + form.getAttribute('data-failure-message') + '</div>';
          document.querySelector('.sc-financial-style__message').innerHTML = failureHtml;
          document.querySelector('.sc-financial-style__message').style.display = 'block';
          return false;
        }
        ...
        let successHtml =
          ...
          sgrID +
          '</span></div>';
        document.querySelector('.sc-financial-style__message').innerHTML = successHtml;
        document.querySelector('.sc-financial-style__message').style.display = 'block';
        ...
        let disclaimerNote = document.querySelector('.sc-financial-style__segment-four-notes');
        if (disclaimerNote) {
  ...
  adobeFormSuccess(customLinkText) {
    ...
    if (typeof window.digitalData == 'object') {
      ...
      let labelText = '',
        labelValue = '';
      let formSelect = document.querySelector('.sc-financial-style__segment-four-wrapper');
      let allFields = formSelect.querySelectorAll('.modular-form .modular-form-container');
      if (allFields.length) {
  ...
  commonAdobeScript() {
    ...
    if (typeof window.digitalData == 'object') {
      ...
      window.digitalData.page.pageInfo.libDetails = _satellite.environment.stage;
  ...
  getIntExtCampaignInfo() {
    ...
    allowableQueryString = ['aggregator_code', 'aggregator_type', 'aggregator_instance']; //missing parameter added
    // eslint-disable-next-line no-unused-vars
    for (let i in allowableQueryString) {
      if (intCampaignName) {
        intCampaignName += ':';
  ...
  prepareXMLData() {
    ...
    let allFields = document.querySelectorAll('.c-modal.is-open .modular-form-container');
    if (allFields.length) {
      for (let i = 0; i < allFields.length; i++) {
        let attr = allFields[i].getAttribute('data-field-type');
        ...
        if (attr == 'alphabetic-text') {
          ...
          fieldValue[name] = allFields[i].querySelector('input:checked') ? 'yes' : 'no';
    ...
    if (formStatus) {
      fieldValue['contact'] =
        fieldValue['contact'].length >= minLength ? fieldValue['contact'] : fieldValue['email'];
    }

    const browserName =
      Utils.browserDetect.searchString(Utils.browserDetect.dataBrowser) || 'Other';
    ...
    fieldValue['device-info'] = Utils.getDeviceDetails().deviceInfo === 'm' ? 'mobile' : 'desktop';
    fieldValue['fullurl'] = encodeURIComponent(window.location.href);

    const urlParams = Utils.convertQueryStringToJsonObject(Utils.getPageUrl().queryString);
    fieldValue['product-name'] = urlParams['productName'] ? urlParams['productName'] : '';
    fieldValue['campaign-id'] = urlParams['campaign_id'] ? urlParams['campaign_id'] : '';
    ...
    for (let index in allowableQueryString) {
      ...
      if (cookieValue) {
        ...
        let localStorageValue = Utils.getLocalStorageWithExpiry(allowableQueryString[index]);
        fieldValue[`${allowableQueryString[index]}`] = localStorageValue ? localStorageValue : '';
      }
    }
